...
fun day02par1(input: List<String>): Int = input.count { isSafe(it.split(" ").map(String::toInt)).first }

fun day02par2(input: List<String>): Int = input.count { isSafeWithDampener(it.split(" ").map(String::toInt)) }

fun main() {
    val day = "day02"

    validateInput("$day-part1-example", 2) {
        day02par1(readInput("$day/example"))
    }
...
//    }
    ...
    stressTest("$day-part1-input", 10, 100) {
        day02par1(readInput("$day/input"))
    }

    //  part2
    validateInput("$day-part2-example", 4) {
        day02par2(readInput("$day/example"))
    }
