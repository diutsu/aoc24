...
fun day04part1(input: List<List<Char>>): Int {
    val rows = input.size
...
fun day04part2(input: List<List<Char>>): Int {
...
fun main() {
    ...
    validateInput("$day-day04part1", 18) {
        day04part1(readFileAsMatrix("$day/example"))
    }

    runDay("$day-day04part1", 2514) {
        day04part1(readFileAsMatrix("$day/input"))
    }

    validateInput("$day-day04part2", 9) {
        day04part2(readFileAsMatrix("$day/example"))
    }
    // 1213 too low
    runDay("$day-day04part2", 1888) {
        day04part2(readFileAsMatrix("$day/input"))
    }
}
